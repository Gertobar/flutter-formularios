...
import 'package:forms_app/features/presentation/blocs/counter_bloc/counter_bloc.dart';
...
class BlocCounterView extends StatelessWidget {
  ...
  void increaseCounterBy(BuildContext contex, [int value = 1]) {
    // contex.read<CounterBloc>()
    // .add(CounterIncresed(value));
    contex.read<CounterBloc>().increaseBy(value);
  }
